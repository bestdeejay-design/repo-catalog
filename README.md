...
## Продукты и платформы (8)

| Репозиторий | Описание | Язык | Доступ | Локально | Обновлён |
|---|---|---|---|---|---|
| [`knowledge-base`](https://github.com/bestdeejay-design/knowledge-base) | Бесплатный RAG-сервис корпоративной базы знаний (free-tier / локальные модели, без платных ключей) | TypeScript | 🔓 | — | 2026-07-20 |
...
| [`arental-rental`](https://github.com/bestdeejay-design/arental-rental) | старый сайт атмосферы | HTML | 🔓 | — | 2026-06-06 |
...
## Демо-приложения и прототипы (12)
...
| Репозиторий | Описание | Язык | Доступ | Локально | Обновлён |
|---|---|---|---|---|---|
| [`basedata`](https://github.com/bestdeejay-design/basedata) | База данных и бэкенд-сервис (PHP + Docker): схемы, миграции, утилиты. | PHP | 🔒 | — | 2026-08-20 |
| [`catalog`](https://github.com/bestdeejay-design/catalog) | Категории заведений: JSON-датасет (иерархия, иконки, сортировка) + скрипты анализа и валидации да… | JavaScript | 🔓 | — | 2026-08-20 |
| [`ybase-tsp`](https://github.com/bestdeejay-design/ybase-tsp) | 7000 Каталог заведений 6734 y | PLpgSQL | 🔓 | — | 2026-06-06 |

## Инструменты и утилиты (8)

| Репозиторий | Описание | Язык | Доступ | Локально | Обновлён |
|---|---|---|---|---|---|
| [`agent-skills`](https://github.com/bestdeejay-design/agent-skills) [🌐](https://bestdeejay-design.github.io/agent-skills/) | Agent Skills - 46 skills for AI agents (Sisyphus, opencode): frontend-perfection (Lighthouse audi… | Python | 🔓 | agent-skills | 2026-08-19 |
| [`design-demo`](https://github.com/bestdeejay-design/design-demo) [🌐](https://bestdeejay-design.github.io/design-demo) | Каталог UI/UX решений и примеров дизайна. Компоненты, страницы, паттерны, анимации, промышленный… | HTML | 🔓 | design-rnd | 2026-08-08 |
| [`designer-references`](https://github.com/bestdeejay-design/designer-references) | Справочник дизайнера — статический визуальный справочник референсов (Behance/Dribbble/Figma/Pinte… | HTML | 🔓 | references | 2026-07-15 |
| [`imgforge`](https://github.com/bestdeejay-design/imgforge) [🌐](https://bestdeejay-design.github.io/imgforge/) | Crop and optimize images right in the browser — aspect ratios, exact sizes, quality and target fi… | JavaScript | 🔓 | imgforge | 2026-08-17 |
| [`oc-architecture`](https://github.com/bestdeejay-design/oc-architecture) | Схема архитектуры OpenCode: агенты, MCP, LSP, скиллы, RAG/память | Shell | 🔒 | oc-architecture | 2026-07-19 |
| [`opencode-setup`](https://github.com/bestdeejay-design/opencode-setup) | Настройка рабочей среды opencode (Sisyphus): конфиги, MCP-серверы, скиллы, сервис обслуживания. П… | Shell | 🔒 | opencode-setup | 2026-08-20 |
| [`raster-to-svg`](https://github.com/bestdeejay-design/raster-to-svg) | PNG→SVG converter: pure-Python tracer + vtracer engine, local web UI with magnifier, presets and… | Python | 🔓 | raster-to-svg | 2026-08-19 |
| [`svg-readme-header-footer`](https://github.com/bestdeejay-design/svg-readme-header-footer) [🌐](https://bestdeejay-design.github.io/svg-readme-header-footer/) | Single-file visual editor for animated SVG banners (header/footer) for GitHub READMEs. Live previ… | HTML | 🔓 | svg-readme-header-footer | 2026-08-12 |

## Книги и контент (4)

| Репозиторий | Описание | Язык | Доступ | Локально | Обновлён |
|---|---|---|---|---|---|
| [`awesome-ai-handbook`](https://github.com/bestdeejay-design/awesome-ai-handbook) [🌐](axiiom.ru) | A practical guide to AI: from running your first local model to building your own agents. 52 file… | HTML | 🔓 | — | 2026-08-19 |
| [`awesome-local-ai`](https://github.com/bestdeejay-design/awesome-local-ai) | An awesome repository of local AI tools | — | 🔓 | — | 2026-07-27 |
| [`awesome-local-llm`](https://github.com/bestdeejay-design/awesome-local-llm) | A curated list of awesome platforms, tools, practices and resources that helps run LLMs locally | — | 🔓 | — | 2026-07-27 |
| [`shimmer`](https://github.com/bestdeejay-design/shimmer) [🌐](https://bestdeejay-design.github.io/shimmer/) | Мерцание (Shimmer) — научно-философская сага о вечности сознания, циклах времени и силе снов. Кни… | JavaScript | 🔓 | shimmer | 2026-08-19 |

## Документация (3)

| Репозиторий | Описание | Язык | Доступ | Локально | Обновлён |
|---|---|---|---|---|---|
| [`docs`](https://github.com/bestdeejay-design/docs) | Документация проекта: спецификация, шаблоны, анализ | Python | 🔒 | docs | 2026-06-22 |
| [`docsv`](https://github.com/bestdeejay-design/docsv) | Проект «Витрина» — документация: контекст, планы W1-W12, спецификации, требования. | — | 🔓 | — | 2026-08-20 |
| [`srs-docs`](https://github.com/bestdeejay-design/srs-docs) [🌐](https://bestdeejay-design.github.io/srs-docs/) | Software Requirements Specification | HTML | 🔓 | srs-docs | 2026-08-09 |
...
## Локальные папки без remote (в `~/Projects`)

| Папка | Примечание |
|---|---|
| `aotochka.ru` | рабочая копия / не-репозиторий |
| `arental` | рабочая копия / не-репозиторий |
| `axiiom` | рабочая копия / не-репозиторий |
| `axiiom-ru` | рабочая копия / не-репозиторий |
| `axiiom_new` | рабочая копия / не-репозиторий |
| `best` | рабочая копия / не-репозиторий |
| `dajet` | рабочая копия / не-репозиторий |
| `design-rnd` | рабочая копия / не-репозиторий |
| `docv` | рабочая копия / не-репозиторий |
| `factmat` | рабочая копия / не-репозиторий |
| `local-coding` | рабочая копия / не-репозиторий |
| `neo-deck` | рабочая копия / не-репозиторий |
| `platforma` | рабочая копия / не-репозиторий |
| `reddit` | рабочая копия / не-репозиторий |
| `research` | рабочая копия / не-репозиторий |
| `research_pull` | рабочая копия / не-репозиторий |
| `skills-repo` | рабочая копия / не-репозиторий |
| `test` | рабочая копия / не-репозиторий |
| `архив/archive` | рабочая копия / не-репозиторий |
| `презентация` | рабочая копия / не-репозиторий |
